...
<?php
	...
	$query="select * from room_book_admin ORDER BY id DESC";
	$rs=$conn->query($query);
?>

<div class="headertext_gallary">ROOM BOOKING<hr color="#036" width="206%"></div>
...
<table class="disptable" width="200%">
	<tr>
		...
		<th width="5%" align="center">Birth Date</th>
        <th width="*" align="center">Address</th>
        <th width="12%" align="center">E-Mail Id</th>
        <th width="8%" align="center">Mobile No.</th>
        <th width="5%" align="center">Check-In</th>
        <th width="6%" align="center">Ckech-Out</th>
        <th width="6%" align="center">No. Of Person</th> 
        <th width="8%" align="center">Room Type</th>
        <th width="5%" align="center">No. Of Rooms</th>
