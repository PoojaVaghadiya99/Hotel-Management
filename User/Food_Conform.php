...
<?php
	echo "<tr><th colspan='4'>Payment</th></tr>";	
    echo "<tr><td>Meal Plan</td><td>".$_POST["food"]."</td><td>".$_POST["qty"]."</td><td>".$_POST["price"]."</td></tr>";
    echo "<tr><td>Total Price</td><td colspan='3'>".$_POST["total"]."</td></tr>";
    echo "<tr><td>Payment Type</td><td colspan='3'>
...
<?php
	...
	echo "<tr>
			<td><center><a class='link_button' href='Food_Zone.php'>Conform</a></center></td>
		</tr>";
?>
